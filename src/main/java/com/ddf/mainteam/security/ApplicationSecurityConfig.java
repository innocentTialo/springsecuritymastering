...
//                .antMatchers(HttpMethod.DELETE, "/management/api/**").hasAuthority(STUDENT_READ.getPermission())
//                .antMatchers(HttpMethod.POST, "/management/api/**").hasAuthority(STUDENT_READ.getPermission())
